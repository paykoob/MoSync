...
extern __declspec(noreturn) unsigned DSPMCR6 (ARMul_State *, unsigned, ARMword, ARMword);
extern __declspec(noreturn) unsigned DSPMRC6 (ARMul_State *, unsigned, ARMword, ARMword *);
extern __declspec(noreturn) unsigned	DSPCDP6 (ARMul_State *, unsigned, ARMword);
