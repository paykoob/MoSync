...
enum TParseException
	...
	ErrLocalizedVendorNamesAlreadyDefined,
	ErrVendorNameAlreadyDefined
	};
...
#define DEVPROP_TOKEN		8
#define APPPROP_TOKEN		9
#define GE_TOKEN			10
#define LE_TOKEN			11
#define NE_TOKEN			12
#define IF_TOKEN			13
...
// a variant, i.e. either a number or string value
	{
	ULONG dwNumber;					// numeric value, e.g. 100
...
// The base input (pkg) parser class. Pass details to a CSISWriter for later use.
	...
	private:
		...
		void ParseHeaderL();
		void ParseLocalizedVendorNamesL();
